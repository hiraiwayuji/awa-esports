...
export const staff: StaffMember[] = [
  {
    ...
    bio: {
      headline: "本名：平岩裕治。元 大塚FC（→徳島ヴォルティス）プロサッカー選手、のちにヴォルティスで「ボールくん」としてイベントで活躍。現在は藍住で「ボール接骨院」を営みつつ、副業で動画編集・AIシステム化・すだち農家も手がける、領域横断の連続事業家。",
      paragraphs: [
        "元 大塚FC（現 徳島ヴォルティスの前身）のプロサッカー選手として徳島のフットボールシーンで活躍した後、徳島ヴォルティス（J-League）で「ボールくん」としてイベントの場に立ち、地元・徳島の応援文化のど真ん中に長く居続けた人物。プロクラブの現場で磨かれた「人を巻き込み、熱量で空気をつくる」感覚は、AWA ESPORTSのチームビルディングの礎にもなっている。",
        "現在は徳島県藍住町で「ボール接骨院」を経営しながら、副業で動画編集・AIシステム化・すだち農家にも取り組むなど、領域を越えて挑戦を続ける。「徳島から世界へ」を旗印に、経歴も年齢も関係なく、本気で挑む全ての人の背中を押す──それがAWA ESPORTS代表としての信条。",
      ],
      highlights: [
        "AWA ESPORTS 創業者・代表",
        "元 大塚FC プロサッカー選手",
  ...
  },
  {
    ...
    bio: {
      headline: "徳島・藍住町を拠点に活動するブランディングデザイナー（ゼノブランディング 代表）。戦略から伴走するクリエイティブで、AWA ESPORTSのブランドを磨く。",
      paragraphs: [
  ...
  },
  {
    ...
    bio: {
      ...
      paragraphs: [
        ...
        "「明日も誰かの面白かったのために」をモットーに、現場の熱を情熱と絶叫で届ける。AWA ESPORTSにおいては、試合やイベントを実況解説で盛り上げ、観る側のテンションを最大化する CASTER ロールを担う。",
      ],
      highlights: [
...
export const legendPlayers: Player[] = [
  ...
  { name: "カジコ" },
  {
    ...
    bio: {
      headline: "本名：平岩裕治。元 大塚FC（→徳島ヴォルティス）プロサッカー選手。AWA ESPORTS 代表が自らアタッカーとしてSF6の最前線に立つ。",
      paragraphs: [
