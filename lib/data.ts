  ...
  },
  {
    ...
    bio: {
      ...
      paragraphs: [
        ...
        "2018年のFISE広島では日本人最年長にして5位入賞を果たし、再起を決断。徳島に拠点を構え、BMXスクール「Voyage BMX」を主宰しながら次世代の育成にも力を注ぐ。「世界一の身体感覚」と「プレッシャー下での集中力」をAWA ESPORTSに持ち込み、競技横断の知見でチームを底上げする存在。",
      ],
      highlights: [
        "BMXフラットランド 初代世界王者（2007年）",
        "BMX国内年間王者（2001年）",
        "FISE広島 日本人最年長5位入賞（2018年）",
        "Voyage BMX School 主宰（徳島県阿南市）",
      ],
      links: [
        { label: "Instagram", url: "https://www.instagram.com/hiroyamorizaki/" },
        { label: "Voyage BMX", url: "https://www.voyagebmxschool.com/" },
      ],
    },
  },
  {
