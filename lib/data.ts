...
export const staff: StaffMember[] = [
  {
    ...
    bio: {
      headline: "本名：平岩裕治。元 大塚FC（→徳島ヴォルティス）プロサッカー選手、後にチーム公式マスコット「ぼーるくん」。現在は藍住で「ボール接骨院」を営みつつ、副業で動画編集も手がける、領域横断の連続事業家。",
      paragraphs: [
        "元 大塚FC（現 徳島ヴォルティスの前身）のプロサッカー選手として徳島のフットボールシーンで活躍した後、徳島ヴォルティス（J-League）の人気マスコット「ぼーるくん」として、地元・徳島の応援文化のど真ん中に長く立ってきた人物。プロクラブの現場で磨かれた「人を巻き込み、熱量で空気をつくる」感覚は、AWA ESPORTSのチームビルディングの礎にもなっている。",
