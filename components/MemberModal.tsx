...
const accentMap = {
  ...
  magenta: {
    border: "border-awa-magenta/60",
    text: "text-awa-magenta",
    glow: "shadow-[0_0_60px_rgba(255,45,149,0.35)]",
    bg: "from-awa-magenta/10 to-transparent",
    bullet: "bg-awa-magenta",
  },
  violet: {
    border: "border-awa-violet/60",
    text: "text-awa-violet",
    glow: "shadow-[0_0_60px_rgba(155,92,255,0.35)]",
    bg: "from-awa-violet/10 to-transparent",
    bullet: "bg-awa-violet",
  },
  warmth: {
    border: "border-awa-warmth/60",
    text: "text-awa-warmth",
    glow: "shadow-[0_0_60px_rgba(255,170,80,0.35)]",
    bg: "from-awa-warmth/10 to-transparent",
    bullet: "bg-awa-warmth",
  },
};
